...
public class Sandbox {
    public static void main(String[] args) {
        ...
        // of 3% and you add $100 at the end of each year
        ...
        //Counting loops need an *index*: what iteration of the loop is the programming running?
        ...
        while (year < finalYear) {
            ...
            System.out.println("At the end of year " + year + ", value =$ " + String.format("%.2f", currentValue));
        ...
        //Start the loop
        //User enters integers  and the program stops when the value enterd is the sentinel
